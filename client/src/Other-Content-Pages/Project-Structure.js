/**
 * This page is used for when a person wants to learn how use the BAER Protocol
 * It contains a pdf viewer and a pdf that gives a detailed outline of the BAER Protocol
 */
...
function ProjectStructure({that}) {
        ...
        return (
            <div>
                ...
                <div style={{ height: (that.state.ScreenHeight), width: "82%", float: "left"}}>
                    <object width="100%" height="95%" data="/Final-Documentation-Document.pdf" type="application/pdf"></object>
                </div>
            </div>
        )
    }
    ...
    if ((that.state.ScreenHeight > that.state.ScreenWidth) || (that.state.MobileCheck === true)) {
        return (
            <div>
                ...
                <div style={{ height: (that.state.ScreenHeight), width: "100%", float: "left"}}>
                    <object width="100%" height="95%" data="/Final-Documentation-Document.pdf" type="application/pdf"></object>
                </div>
            </div>
        )
