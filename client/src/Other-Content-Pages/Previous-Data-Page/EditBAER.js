/**
 * This is the page that is designed to allow a user to edit specific data for BAER collection protocols
 */
...
function EditBAER({that}) {
    ...
    const rerender = () => {
        //-----------------------------------------------------------------------------------------------------------------//
        //If the site is in landscape - Doesn't matter if its mobile or not
                ...
                return (
                    <div>
                        ...
                        <div align={"center"} style={{ height: (that.state.ScreenHeight), width: "35%", float: "left"}}>
                            ...
                            <br/>
                            <div className={"center"}>
                                <Link onClick={that.EditDataBAER} to="/soilinfiltrometer/index.html"
                                      style={{textDecoration: 'none'}}>
