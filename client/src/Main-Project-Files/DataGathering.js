/**
 * This page is used to render when a user routes to data gathering for time protocol
 */
...
function DataGathering({that}) {
    // that.state.currentTimeInInterval = that.state.timeInterval;
    ...
    const Name = [
        {id: 0, name: "Data Collecting: Application is Running (Time)"},
    ]
                ...
                <div align={"center"}>
                    <table>
                        <tr>
                            ...
                            <td><h3><Timer initialTime={that.state.TotalTime * 1000}
    ...
    const renderTimeInterval = () => {
        return (
            <div style={{ height: (that.state.ScreenHeight * .03), width: "30%"}} align={"right"}>
                <tr>
